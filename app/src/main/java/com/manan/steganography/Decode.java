package com.manan.steganography;
...
import com.manan.imagesteganographylibrary.Text.AsyncTaskCallback.TextDecodingCallback;
import com.manan.imagesteganographylibrary.Text.ImageSteganography;
import com.manan.imagesteganographylibrary.Text.TextDecoding;
        ...
        if (result != null) {
            if (!result.isDecoded())
                ...
                if (!result.isSecretKeyWrong()) {
                    ...
                    Toast.makeText(this, "Wrong secret key", Toast.LENGTH_LONG).show();
                }
            }
        } else {
